...
./godelw exec -- go get github.com/golangci/gofmt

Output:
go: module github.com/golangci/gofmt: Get "https://proxy.golang.org/github.com/golangci/gofmt/@v/list": dial tcp 142.251.211.177:443: i/o timeout
Error: exit status 1
