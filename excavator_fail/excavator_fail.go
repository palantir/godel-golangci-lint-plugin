...
Output:
go: module github.com/golangci/golangci-lint/v2: Get "https://proxy.golang.org/github.com/golangci/golangci-lint/v2/@v/list": dial tcp 142.251.211.177:443: i/o timeout
Error: exit status 1
